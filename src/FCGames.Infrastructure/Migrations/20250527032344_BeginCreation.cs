...
namespace FCGames.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class BeginCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 4),
